...
describe('NotificationIcon', () => {
    describe('experience type', () => {
        it('renders DoubleUp icon for experience type', () => {
            render(<NotificationIcon type={'experience'} id={'n1'} read={false} />)
    ...
    describe('error type', () => {
        it('renders ReportError icon for error type', () => {
            render(<NotificationIcon type={'error'} id={'n1'} read={false} />)
    ...
    describe('success type', () => {
        it('renders CheckCircle icon for success type', () => {
            render(<NotificationIcon type={'success'} id={'n1'} read={false} />)
    ...
    describe('level type', () => {
        it('renders a level image for level type', () => {
            render(<NotificationIcon type={'level'} id={'n1'} read={false} meta={{ level: 1, value: 0, title: 'Novice' }} />)
    ...
    describe('type without icon', () => {
        it('renders nothing when no matching type and no place', () => {
            const { container } = render(
                <NotificationIcon type={'achievements' as any} id={'n1'} read={false} />
            )
